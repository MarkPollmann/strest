...
- Easily chain requests/responses to do complex workflows, ex. logging in, setting headers, performing a subsequent request.
...
## SaaS
You can easily develop/test your workflow locally and for many that is all you need every once in a while, however if you need more power/concurrency and/or you want to make stress testing part of your CI/CD then a paid SaaS Cloud service will be available shortly.
